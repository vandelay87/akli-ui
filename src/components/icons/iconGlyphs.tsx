...
// width/height match iconViewPublic above — Link's `.icon` (composing
// `linkIcon` from interactions.module.css) has no width/height rule of its
// own, so the SVG's own attributes are what size it there.
